...
// #define wal "/home/mili/.cache/wal/colors-wal-dwm.h"
...
#define TAGKEYS(KEY,TAG) \
    ...
    { MODKEY2,                       KEY,      focusnthmon,    {.i  = TAG } }, \
	{ MODKEY2|ShiftMask,             KEY,      tagnextmon,     {.ui = 1 << TAG} }, \
	// { MODKEY|MODKEY2|ShiftMask,      KEY,      tagprevmon,     {.ui = 1 << TAG} },
    // { MODKEY2|ShiftMask,             KEY,      tagnthmon,      {.i  = TAG } }, \ 
